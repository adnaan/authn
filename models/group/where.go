...
func HasGroupRoles() predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
...
func HasGroupRolesWith(preds ...predicate.GroupRole) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasWorkspaces() predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasWorkspacesWith(preds ...predicate.Workspace) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
