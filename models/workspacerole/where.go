...
func AccountID(v uuid.UUID) predicate.WorkspaceRole {
	return predicate.WorkspaceRole(func(s *sql.Selector) {
...
func AccountIDEQ(v uuid.UUID) predicate.WorkspaceRole {
	return predicate.WorkspaceRole(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldAccountID), v))
	})
}
...
func AccountIDNEQ(v uuid.UUID) predicate.WorkspaceRole {
	return predicate.WorkspaceRole(func(s *sql.Selector) {
...
func AccountIDIn(vs ...uuid.UUID) predicate.WorkspaceRole {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func AccountIDNotIn(vs ...uuid.UUID) predicate.WorkspaceRole {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func AccountIDGT(v uuid.UUID) predicate.WorkspaceRole {
	return predicate.WorkspaceRole(func(s *sql.Selector) {
...
func AccountIDGTE(v uuid.UUID) predicate.WorkspaceRole {
	return predicate.WorkspaceRole(func(s *sql.Selector) {
...
func AccountIDLT(v uuid.UUID) predicate.WorkspaceRole {
	return predicate.WorkspaceRole(func(s *sql.Selector) {
...
func AccountIDLTE(v uuid.UUID) predicate.WorkspaceRole {
	return predicate.WorkspaceRole(func(s *sql.Selector) {
...
func AttributesIsNil() predicate.WorkspaceRole {
	return predicate.WorkspaceRole(func(s *sql.Selector) {
...
func AttributesNotNil() predicate.WorkspaceRole {
	return predicate.WorkspaceRole(func(s *sql.Selector) {
...
func HasAccounts() predicate.WorkspaceRole {
	return predicate.WorkspaceRole(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasAccountsWith(preds ...predicate.Account) predicate.WorkspaceRole {
	return predicate.WorkspaceRole(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
